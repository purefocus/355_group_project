...
public class CatalogEntryNew extends BaseActivity
{
...
//		setContentView(R.layout.activity_catalog_new);
	...
	{
		return R.layout.activity_catalog_new;
	}
	...
	public void btn_make_entry(View v)
	{
		...
		if (v.getId() == R.id.btn_make_catalog_entry)
		{
			...
			if (TextUtils.isEmpty(title) || TextUtils.isEmpty(description) || TextUtils
					                                                                  .isEmpty(coordinates) || catImgView
							                                                                                           .getDrawable() == null)
			{
